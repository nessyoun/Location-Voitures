...
<body class="bg-dark">
    <div id="app">
        <div class="sidebar" id="sidebar">
            <h2 class="mx-3 my-4 text-center po" ><?php echo e(config('app.name', 'Laravel')); ?></h2>
            <br><br>
            <ul class="nav flex-column w-100">
                ...
                <?php elseif(auth()->user()->hasRole('commercial')): ?>
                    <li class="nav-item ">
                ...
                <?php elseif(auth()->user()->hasRole('normal_client')): ?>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item a">
                        <a class="nav-link a" id="res" href="/reservations/<?php echo e(auth()->user()->client_id); ?>"><i class="fa-solid fa-cart-shopping"></i> Mes réservations</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
